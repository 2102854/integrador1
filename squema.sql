...
CREATE TABLE TIPO_RESPONSAVEL (
    TIPO_RESPONSAVEL_ID INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE NOT NULL,
...
CREATE TABLE RESPONSAVEL (
    RESPONSAVEL_ID      INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE NOT NULL,
    TIPO_RESPONSAVEL_ID CONSTRAINT [RESPONSAVEL#TIPO_RESPONSAVEL_FK] REFERENCES TIPO_RESPONSAVEL (TIPO_RESPONSAVEL_ID) NOT NULL,
    NOME                TEXT (50) UNIQUE NOT NULL,
...
CREATE TABLE AGENDAMENTO (
    ...
    RESPONSAVEL_ID_AGENDAMENTO  CONSTRAINT [AGENDAMENTO#RESPONSAVEL_A_FK] REFERENCES RESPONSAVEL (RESPONSAVEL_ID) NOT NULL,
    RESPONSAVEL_ID_MOTORISTA    CONSTRAINT [AGENDAMENTO#RESPONSAVEL_M_FK] REFERENCES RESPONSAVEL (RESPONSAVEL_ID) NOT NULL,
    ESTADO_GERAL_PACIENTE       TEXT (500) NOT NULL,
    DATA_REMOCAO                TEXT (20)  NOT NULL,
    HORA_REMOCAO                TEXT (20)  NOT NULL,
    SAIDA_PREVISTA              TEXT (20) NOT NULL,
    HORA_SAIDA                  TEXT (20)  NOT NULL,
...
CREATE TABLE AGENDAMENTO_RESPONSAVEL (
    AGENDAMENTO_RESPONSAVEL_ID INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE NOT NULL,
    AGENDAMENTO_ID             CONSTRAINT [AGENDAMENTO_RESPONSAVEL#AGENDAMENTO_FK] REFERENCES AGENDAMENTO (AGENDAMENTO_ID) NOT NULL,
    RESPONSAVEL_ID             CONSTRAINT [AGENDAMENTO_RESPONSAVEL#RESPONSAVEL_FK] REFERENCES RESPONSAVEL (RESPONSAVEL_ID) NOT NULL
);
